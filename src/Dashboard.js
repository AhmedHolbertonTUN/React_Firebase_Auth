      ...
      {firebase.getCurrentUsername() ? (
        <div className="container1">
          ...
          <div className="text-container">
            <p className="title-text">{firebase.getCurrentUsername()}</p>
            <p className="info-text">Web Developer</p>
            <p className="desc-text">
              Hello, I am {firebase.getCurrentUsername()} and I enjoy front-end
              web development.
            </p>
            <button className="w3-button w3-teal" onClick={logout}>
              LogOut
            </button>
          </div>
        </div>
